...
async function syncAll17Authors() {
  console.log("Syncing all 17 team members (including İrem, Ayça Sude Kaya, Nisa, Zeynep Sare, Doğancan) to Supabase Cloud...");
  ...
  else console.log("✅ site_settings authors_ordered_list updated with ALL 17 AUTHORS!");

  // 2. Update authors table
  for (const auth of all17Authors) {
  ...
  console.log("✅ authors table updated with ALL 17 AUTHORS!");

  console.log("🎉 SUCCESS: ALL 17 TEAM MEMBERS (İrem, Ayça Sude Kaya, Nisa, Zeynep Sare, Doğancan, vb.) ARE RESTORED!");
  process.exit(0);
}

syncAll17Authors().catch(e => { console.error(e); process.exit(1); });
