    ...
    <div className="top-bar">
      <div className="container top-bar-inner">
        <div className="top-socials">
          ...
          {/* X / TWITTER SVG */}
          <a href="https://x.com" target="_blank" rel="noreferrer" className="top-social-icon" title="X (Twitter)">
          ...
          {/* INSTAGRAM SVG */}
          <a href="https://instagram.com" target="_blank" rel="noreferrer" className="top-social-icon" title="Instagram">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* YOUTUBE SVG */}
          <a href="https://youtube.com" target="_blank" rel="noreferrer" className="top-social-icon" title="YouTube">
